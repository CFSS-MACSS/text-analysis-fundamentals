...
# Data from Billboard Year-End Hot 100 (1958-present) and the Census Bureau ACS
...
# Hint: To search for matching state names, this df should include both unigrams and bi-grams.
...
# Combine together
# notice: the variable word in this data frame contains all the possible words 
# bigrams that might be state names in all the lyrics
...
# distinct() to deduplicate the states per song (count each state once per song it is mentioned in)
